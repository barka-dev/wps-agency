             ...
             >
               ...
               <li>
                 <Link
                   href="#services"
                  //  target="_blank"
                   className="ud-menu-scroll flex items-center gap-4 rounded-md bg-white/[0.12] px-6 py-[14px] text-base font-medium text-white transition duration-300 ease-in-out hover:bg-white hover:text-dark"
                 >
