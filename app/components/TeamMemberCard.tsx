...
const TeamMemberCard = ({imageUrl, name, role, description}: TeamMemberProps) => {
    return (
        <div className="p-4 lg:w-1/4 md:w-1/2">
            <div className="h-full flex flex-col items-center text-center">
                <Image alt="team" className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4 border" src="/images/avatar.png" width={1200} height={800} />
