...
const Services = () => {
  return (
     <section id='services' className="pb-8 pt-20 dark:bg-dark lg:pb-[70px] lg:pt-[120px]">
       ...
       <div className="-mx-4 flex flex-wrap">
         <div className="w-full px-4">
           <div className="mx-auto mb-12 max-w-[550px] text-center lg:mb-[70px]">
             ...
             Discover how our tailored solutions in digital marketing, web development, and application creation can help you grow, automate processes, and reach more customers effectively.
             </p>
           </div>
         </div>
       </div>
